...
def tile_into_tight_cell(species_coordinates, repeats=(3, 3, 3), noise=None, delta=1.0, density=None):
    ...
    assert repeats[0] >= 1, 'At least 1 molecule should be present'
    assert repeats[1] >= 1, 'At least 1 molecule should be present'
    assert repeats[2] >= 1, 'At least 1 molecule should be present'
