...
try:
    ...
    path = os.getcwd()
training_path = os.path.join(path, '/home/ignacio/Git-Repos/torchani/dataset/COMP6/COMP6v1/GDB07to09/gdb11_07_test500.h5')
validation_path = os.path.join(path, '/home/ignacio/Git-Repos/torchani/dataset/COMP6/COMP6v1/GDB07to09/gdb11_08_test500.h5')  # noqa: E501
